...
const KEEPER_TRIGGER_SIZE := Vector3(13,2.5,3)
const COVENANT_TRIGGER_SIZE := Vector3(13,2.5,3)
const CATACOMB_ENTRY_TRIGGER_SIZE := Vector3(7.2,2.5,3)
const TEMPLE_GATE_TRIGGER_SIZE := Vector3(28,3.0,4)
